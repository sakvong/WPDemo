jQuery(document).ready(function($){
    ...
    function checkHomeSectionFormat(){
        ...
        if(typeof format != 'undefined'){
			...
			$('#of-option-homeoptions div[id^=section-home_main_slider]').hide();
			...
			if( format == "Main Slider" ){

                $('#of-option-homeoptions div[id^=section-home_main_slider]').stop(true,true).fadeIn(500);
            }
