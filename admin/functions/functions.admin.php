...
$global_theme_options = of_get_options();

if ( !isset($global_theme_options) || count( $global_theme_options ) <= 1 ){
    ...
    global $of_options;
    $default_options_machine = new Options_Machine($of_options);
    $global_theme_options  = $default_options_machine->Defaults;
