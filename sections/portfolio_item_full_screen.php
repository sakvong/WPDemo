...
function get_featured_image_metadata( $image_id ){
    ...
    $attachment_image_title     = __("Image Title", 'newave_theme');
    $attachment_image_caption   = "";
    $attachment_image_desc      = __("Image Description", 'newave_theme');
...
?>
    ...
    <ul id="project-page-button-fullscreen" class="clearfix">
        <li><a id="project_close" class="icon-awesome" href="#" title="<?php _e('Close Project', 'newave_theme'); ?>"></a></li>
    </ul>
    <!--/Project Close Button -->

    <!-- Project Fullscreen Slider -->
    <a href="#" id="arrow_left"><img src="<?php echo get_template_directory_uri(); ?>/images/arrow_left.png" alt="<?php _e('Slide Left', 'newave_theme'); ?>" /></a>
    <a href="#" id="arrow_right"><img src="<?php echo get_template_directory_uri(); ?>/images/arrow_right.png" alt="<?php _e('Slide Right', 'newave_theme'); ?>" /></a>
