...
class NewaveMetaboxes {
    ...
    public function add_meta_boxes()
	{
		...
		// main slider options
		$this->add_meta_box('main_slider_options', 'Slide Options', 'newave_main_slider');
		...
		$this->add_meta_box('page_options_external', 	'External Page Options', 'page');
	}
	...
	public function page_options_external()
	{
		include 'style.php';
		include 'page_options_external.php';
	}
	...
	public function main_slider_options()
	{
		include 'style.php';
		include 'main_slider_options.php';
	}
