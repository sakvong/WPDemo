        ...
        init : function(ed, url) {
            ed.addButton('newave_shortcode_button', {
				...
				menu: [
					...
					
					{
                        ...
                        menu: [
							...
							},
							{
								text: 'Info Box',
								onclick: function () {
									tb_show("Add Info Box", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup/shortcodes_popup.php?&sc=newave_info_box&width=400&height=500');
								}
							},
							{
								text: 'Parallax Link',
							...
							},
							{
								text: 'Posts Carousel',
								onclick: function () {
									tb_show("Add Recent Posts in Carousel", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup/shortcodes_popup.php?&sc=posts_carousel&width=400&height=500');
								}
							},
							{
								text: 'Service Box',
					...
					{
                        text: 'Team Member - Modern',
                        onclick: function () {
                            tb_show("Add Team Member", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup/shortcodes_popup.php?&sc=team_modern&width=700&height=600');
                        }
                    },
