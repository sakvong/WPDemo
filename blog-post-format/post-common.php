...
?>
    ...
    <?php if( $global_theme_options['blog_layout'] == "Normal" ) { ?>
        <p class="blog-meta">
            <?php if( $global_theme_options['author_info'] ){ ?>
                <?php _e( 'Posted by', 'newave_theme' ); ?> <?php the_author_posts_link(); ?> |
            <?php } ?>
            <?php if ( has_tag() ) { ?>
                <?php the_tags('', ' · ', ''); ?> |
            <?php } else { ?>
                <?php _e( 'No Tags', 'newave_theme' ); ?> |
            <?php } ?>
            <?php the_category(' · '); ?>
    ...
    <?php if( $global_theme_options['blog_layout'] == "Normal" ) { ?>
        <a href="<?php the_permalink(); ?>" class="newave-button medium color external"><?php _e( "Read More", 'newave_theme' ); ?></a>
    <?php } else { ?>
        <a href="<?php the_permalink(); ?>" class="newave-button small grey external"><?php _e( "Read More", 'newave_theme' ); ?></a>
    <?php } ?>
