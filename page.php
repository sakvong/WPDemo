...
if( have_posts() ){
	...
	// if the page has a header image
	$header_image = get_post_meta(get_the_ID(), 'newave_page_external_header_image', true);
	if( !empty( $header_image ) ){

        get_template_part('sections/external_page_header_section');
    }
...
<section <?php echo $section_style; ?>>
    ...
    <?php
    $container_type = get_post_meta(get_the_ID(), 'newave_page_external_default_container', true);
